...
//
//     final getAdDataModel = getAdDataModelFromJson(jsonString);

import 'dart:convert';

GetAdDataModel getAdDataModelFromJson(String str) =>
    GetAdDataModel.fromJson(json.decode(str));

String getAdDataModelToJson(GetAdDataModel data) => json.encode(data.toJson());

class GetAdDataModel {
  GetAdDataModel({
    this.success = false,
    this.message,
    this.pageNo,
  ...
  factory GetAdDataModel.fromJson(Map<String, dynamic> json) => GetAdDataModel(
